static char *fonts[] = {
	...
	"Consolas Nerd Font:style=Regular:pixelsize=20",
	"JetBrains Mono:style=Regular:pixelsize=20",
    "MesloLGS NF:style=Regular:pixelsize=20" };
static char *font2[] = {
    "feather:pixelsize=22",
    "Material Design Icons Desktop:style=Regular:pixelsize=22",
